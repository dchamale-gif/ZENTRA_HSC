...
const PacientesModule = {
    ...
    handleDocumentDrop(event) {
        ...
        // Las funciones viejas de documento han sido reemplazadas por handleDocumentFiles()
        // que se invoca automáticamente mediante setupDocumentListeners()
        this.showNotification('⚠️ Por favor usa el campo de carga de documentos en la sección de Tab 7', 'warning');
    },
